...
@export var patched_cow_health := 500
...
func _move_toward_player(_delta):
	...
	direction.y = 0
	direction = direction.normalized()
	# Only set horizontal movement, keep vertical velocity
	velocity.x = direction.x * move_speed
	velocity.z = direction.z * move_speed
...
func _on_shoot_area_body_entered(body: Node3D) -> void:
	pass # Replace with function body

func _on_shoot_area_body_exited(body: Node3D) -> void:
	pass # Replace with function body.
